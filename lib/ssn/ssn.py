...
def calc_init_centroid(images, num_spixels_width, num_spixels_height):
    ...
    # print('*********Inside calc_init_centroid********')
    # print('Centroids after adaptive pooling: ', centroids.shape)
...
def sparse_ssn_iter(pixel_features, num_spixels, n_iter):
    ...
    return sparse_abs_affinity, hard_labels, spixel_features, num_spixels_width
